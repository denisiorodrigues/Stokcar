...
namespace Stokcar.Api.Extensions
{
    public class JsonWithFilesFormDataModelBinder : IModelBinder
    {
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            //Retrieve he form part containg th JSON
...
;            }
            ...
            foreach (var property in bindingContext.ModelMetadata.Properties)
            {
                ...
                {
                    //The IFormFile was sucessfully bound, assign it to corresponding roperty of the model
                    property.PropertySetter(modelName, propertyResult.Model);
                }
            ...
            //Set the suceessfully constructed model as the result of the model binding
